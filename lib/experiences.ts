import { HERO, DESTINATIONS, P, PD, PH } from './images'
...
const VIDEOS = {
  ...
  snorkeling:  'https://videos.pexels.com/video-files/5005121/5005121-hd_1920_1080_30fps.mp4',
  jetSki:      'https://videos.pexels.com/video-files/854572/854572-hd_1920_1080_25fps.mp4',
  aerialCoast: '/hero-video.mp4',
...
export const experiences: Experience[] = [
  {
    ...
    emoji: '💧',
    image: 'https://media-cdn.tripadvisor.com/media/attractions-splice-spp-674x446/0b/23/23/7a.jpg',
  ...
  },
  {
    ...
    gradient: 'linear-gradient(170deg, #3D0A00 0%, #8B1A00 52%, #D4521A 100%)',
    emoji: '🌲',
    image: 'https://media.tacdn.com/media/attractions-splice-spp-674x446/07/9a/88/aa.jpg',
    video: VIDEOS.canopy,
  ...
  },
  {
    ...
    gradient: 'linear-gradient(170deg, #1A2A00 0%, #3A5A00 52%, #7B9B1A 100%)',
    emoji: '🎵',
    image: 'https://media-cdn.tripadvisor.com/media/attractions-splice-spp-720x480/06/88/cb/b9.jpg',
  ...
  },
  {
    ...
    gradient: 'linear-gradient(170deg, #3D0A00 0%, #8B1A00 52%, #D4521A 100%)',
    emoji: '💦',
    image: '/tours/guests-with-collins.webp',
    video: VIDEOS.waterfall,
