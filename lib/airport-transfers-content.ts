...
export const TRANSFER_FAQS: TransferFaq[] = [
  ...
  },
  {
    ...
    a: 'Free cancellation up to 24 hours before your scheduled pickup time. Inside 24 hours we charge 50% of the fare, your driver is already booked and is turning down other trips. No-shows are charged in full.',
  },
]
