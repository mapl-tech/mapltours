...
export const POSTS_4: BlogPost[] = [
  ...
  },
  {
    ...
    title: "Beaches Ocho Rios Has Closed: Where Families Should Book Instead",
    excerpt:
      "Beaches Ocho Rios closed permanently on May 31, 2025. What happened, what Sandals is building next, and the family resorts on the north coast that fill the gap.",
    category: 'Guides',
    ...
    body: [
      {
        type: 'p',
        text: "If you are searching for Beaches Ocho Rios, here is the news first: the resort closed permanently on May 31, 2025. This was not a renovation pause. Sandals Resorts confirmed the closure, the property's third-party owner is redeveloping the site, and guests with reservations were rebooked at other Sandals and Beaches properties.",
      },
      {
        type: 'p',
        text: "For twenty years it was the default answer to a specific question: where do you take kids for an all-inclusive week on Jamaica's north coast? The water park, the Sesame Street characters, the family suites with bunk rooms. That answer is gone, but the question is not, so here is how we would book the same trip today.",
      },
      { type: 'h2', text: 'What Sandals is doing instead' },
      {
        type: 'p',
        text: "Sandals has said the Beaches brand is expanding, not shrinking: new Beaches resorts are planned for Barbados, Exuma, and, closest to home, Beaches Runaway Bay right here on the Jamaican north coast. No opening date is confirmed as of August 2026. When it opens, it will sit about seventy minutes east of Montego Bay's airport, in the same bay as the Bahia Principe resorts we drive to every week.",
      },
      { type: 'h2', text: 'Where families should book now' },
      {
        type: 'p',
      ...
      },
      {
        ...
        items: [
          ...
          "Bahia Principe Grand, Runaway Bay: the value pick. Large family rooms and a long beach, twenty minutes closer to the airport than Ocho Rios.",
          "Royalton White Sands, Falmouth: modern family suites and a lazy river, and the shortest drive of this list at about forty minutes from MBJ.",
          "Ocean Coral Spring, Trelawny: newer build, waterpark on property, big standard rooms.",
          "Jewel Grande, Montego Bay: suite-style living fifteen minutes from the airport, better for families who hate long transfer days.",
        ],
      },
      {
        type: 'quote',
      ...
      {
        type: 'p',
        text: "And whichever resort you land on, leave the gate at least once. Dunn's River Falls, a jerk lunch at Scotchies, and the Blue Hole will do more for the family memory of Jamaica than any water slide.",
      },
    ],
