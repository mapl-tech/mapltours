...
export const DESTINATIONS: TransferDestination[] = [
  ...
  { id: 'tensing-pen', name: 'Tensing Pen, Negril', parish: 'Westmoreland', zone: 'D', baseRate: 90, estimated: true },
  ...
  { id: 'samsara-cliff-resort', name: 'Samsara Cliff Resort, Negril', parish: 'Westmoreland', zone: 'D', baseRate: 90, estimated: true },
  ...
  // Westmoreland · zone D
  { id: 'banana-shout-resort', name: 'Banana Shout Resort, Negril', parish: 'Westmoreland', zone: 'D', baseRate: 90, estimated: true },
  ...
  { id: 'catcha-falling-star', name: 'Catcha Falling Star, Negril', parish: 'Westmoreland', zone: 'D', baseRate: 90, estimated: true },
  ...
  { id: 'home-sweet-home-resort', name: 'Home Sweet Home Resort, Negril', parish: 'Westmoreland', zone: 'D', baseRate: 90, estimated: true },
  ...
  { id: 'negril-escape-resort-spa', name: 'Negril Escape Resort & Spa', parish: 'Westmoreland', zone: 'D', baseRate: 90, estimated: true },
  ...
  { id: 'the-westender-inn', name: 'The Westender Inn, Negril', parish: 'Westmoreland', zone: 'D', baseRate: 90, estimated: true },
  ...
  { id: 'xtabi-resort', name: 'Xtabi Resort, Negril', parish: 'Westmoreland', zone: 'D', baseRate: 90, estimated: true },
