/**
 * The four accounts, glyph for glyph, for every place that links to them
 * (the footer, the contact page). Inline single-colour SVGs (currentColor),
 * so they inherit the colour of wherever they sit and pull in no icon font.
 */
export const SOCIALS: { label: string; href: string; icon: JSX.Element }[] = [
  {
    label: 'Instagram',
